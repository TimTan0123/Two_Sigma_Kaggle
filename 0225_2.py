...
add_nas_ft=True
nas_cols=['technical_0','technical_9','technical_12','technical_13','technical_16','technical_20','technical_30','technical_32', 'technical_37','technical_38','technical_44']
#columns kept for evolution from one month to another (best selected by the tree algorithms)
add_diff_ft=True
diff_cols=['technical_13','technical_20', 'technical_30']#,'technical_22','technical_34'
...
featureexpander=createLinearFeatures(n_neighbours=30, max_elts=2, verbose=True, random_state=17)
...
model = ensemble.ExtraTreesRegressor(n_estimators=120, max_depth=4, n_jobs=-1, random_state=rnd, verbose=0)
